...
from app.model import pom_model
...
def define_default_args():
    ...
    parser.add_argument('-embedding-dim', type=int, default=200, help='number of embedding dimension [default: 128]')
...
text_cnn = pom_model.TextCNN(args)
if args.snapshot:
